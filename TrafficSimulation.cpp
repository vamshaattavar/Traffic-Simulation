...
void frontscreen(void)
{
	...
	glColor3f(1, 0.5, 0);
	drawstring(600, 300, 0.0, "Vaishnavi P Gavade");
	glColor3f(0, 0, 0);
	drawstring(600, 250, 0.0, "1KT20CS089");
	glColor3f(1, 0.5, 0);
